...
public class AccountBuild_consumer {
    ...
    public void setconsumerID(String fName) {
        consumerID.set(fName);
    }
    ...
    public void setconsumerName(String fName) {
        consumerName.set(fName);
    }
    ...
    public void setconsumerType(String fName) {
        consumerType.set(fName);
    }

    public String getinOutGap() {
        return inOutGap.get();
    }

    public void setinOutGap(String fName) {
        inOutGap.set(fName);
    }
    ...
    public void setdueIN(String fName) {
        dueIN.set(fName);
    }
    ...
    public void setduePay(String fName) {
        duePay.set(fName);
    }
