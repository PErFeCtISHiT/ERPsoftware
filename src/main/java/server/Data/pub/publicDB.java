...
public class publicDB implements pub {
    ...
    */
    @Override
    public ResultMessage exportToExcel(int type, String path) throws IOException {
        generate(type);
        File file = new File(this.getClass().getClassLoader().getResource("sqlplusroot.sql").getPath());
