...
//        TableColumn<Consumer,Integer> yingshouedu=new TableColumn<>("应收额度");
//        TableColumn<Consumer,Integer> yingshou=new TableColumn<>("应收");
//        TableColumn<Consumer,Integer> yingfu=new TableColumn<>("应付");
//        TableColumn<Consumer,Integer> yewuyuan=new TableColumn<>("业务员");
